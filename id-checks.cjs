...
const fs=require('fs');
const html=fs.readFileSync('index.html','utf8')+fs.readFileSync('editor.js','utf8')+fs.readFileSync('maps.js','utf8')+fs.readFileSync('domaine.js','utf8')+fs.readFileSync('shared.js','utf8');
